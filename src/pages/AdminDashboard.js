                ...
                <div className="row justify-content-md-center">
                    <div className="col-lg-8 mb-5 mb-lg-0">
                        <div className="bg-dark shadow rounded-lg p-4 sticky-top"  style={{textAlign: "center"}}>
                            <p style={{color: "white", fontSize: "42px",fontWeight:"bold"}}>Welcome !</p>
                        </div>
                    </div>
                </div>
            </section>
            <div className="row justify-content-md-center">
                <div className="col-lg-4 mb-5 mb-lg-0" >
                    <div className="bg-body shadow rounded-lg p-4 sticky-top" style={{position: "relative"}}>
                        <p style={{ color: "#343a40",fontSize: "32px",fontWeight:"bold", margin: 0}}>{Count.userCount}</p>
                        <span style={{color: "#343a40", fontSize: "20px"}}>Number of users</span>
                ...
                <div className="col-lg-4 mb-5 mb-lg-0">
                    <div className="bg-danger shadow rounded-lg p-4 sticky-top" style={{position: "relative",opacity:"75%"}}>
                        <p style={{color: "white", fontSize: "32px",fontWeight:"bold", margin: 0}}>{Count.bannedUsersCount}</p>
                        <span style={{color: "white", fontSize: "20px"}}>Number of banned users</span>
            ...
            <div className="row justify-content-md-center">
                <div className="col-lg-3 mb-5 mb-lg-0">
                    <div className="bg-warning shadow rounded-lg p-4 sticky-top" style={{position: "relative",opacity:"60%"}}>
                        <p style={{color: "white", fontSize: "32px",fontWeight:"bold", margin: 0}}>{Count.verifiedProjectCount}</p>
                        <span style={{color: "white", fontSize: "20px"}}>Number of untreated report</span>
                ...
                <div className="col-lg-2 mb-5 mb-lg-0" >
                    <div className="bg-body shadow rounded-lg p-4 sticky-top" style={{position: "relative"}}>
                        <p style={{ color: "#343a40",fontSize: "32px",fontWeight:"bold", margin: 0}}>{Count.postCount}</p>
                        <span style={{color: "#343a40", fontSize: "20px"}}>Number of posts</span>
                ...
                <div className="col-lg-3 mb-5 mb-lg-0" >
                    <div className="bg-body shadow rounded-lg p-4 sticky-top" style={{position: "relative"}}>
                        <p style={{ color: "#343a40",fontSize: "32px",fontWeight:"bold", margin: 0}}>{Count.acceptedInvestmentCount}</p>
                        <span style={{color: "#343a40", fontSize: "20px"}}>Number of accepted investments</span>
            ...
            <div className="row justify-content-md-center">
                <div className="col-lg-4 mb-5 mb-lg-0">
                    <div className="bg-info shadow rounded-lg p-4 sticky-top" style={{position: "relative",opacity:"75%"}}>
                        <p style={{color: "white", fontSize: "32px",fontWeight:"bold", margin: 0}}>{Count.verifiedProjectCount}</p>
                        <span style={{color: "white", fontSize: "20px"}}>Number of verified projects</span>
                ...
                <div className="col-lg-4 mb-5 mb-lg-0" >
                    <div className="bg-body shadow rounded-lg p-4 sticky-top" style={{position: "relative"}}>
                        <p style={{ color: "#343a40",fontSize: "32px",fontWeight:"bold", margin: 0}}>{Count.projectCount}</p>
                        <span style={{color: "#343a40", fontSize: "20px"}}>Number of projects</span>
